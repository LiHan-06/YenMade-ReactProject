    ...
    <>
      ...
      >
        <div className="container col-lg-6  text-white text-center">
          ...
          <Link
            to="/allproducts"
            className="btn border btn-font-lg text-white px-4 py-9 mb-224"
          >
            立即選購，醃起你的餐桌日常
          </Link>
          ...
          <div className="container position-relative z-1000 d-flex align-items-center">
            <div className="row justify-content-between align-items-center w-100 pt-5">
              ...
              <div className="col col-lg-2 text-center text-lg-start">
                ...
                <Link
                  to="/allproducts"
                  className="btn btn-outline-primary-500 px-4 py-9 mb-4 mb-lg-288"
                >
                  看更多商品
                </Link>
              </div>
